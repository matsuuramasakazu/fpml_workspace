...
from src.calculators.day_count_calculator import DayCountCalculator
...
class TestDayCountCalculatorFactory:
    ...
    def test_factory_all_methods_supported(self):
        ...
        methods = ["ACT/360", "ACT/365.FIXED", "30/360"]
...
class TestEdgeCases:
    ...
    def test_very_short_periods(self):
        ...
        result_360 = act360.calculate_year_fraction(
            date(2024, 1, 1),
            date(2024, 1, 2)
        )
        result_365 = act365.calculate_year_fraction(
            date(2024, 1, 1),
            date(2024, 1, 2)
        )
