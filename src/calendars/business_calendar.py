...
class BusinessCalendar:
    ...
    def is_business_day(self, val_date: date, business_centers: Union[str, List[str]]) -> bool:
    ...
    def adjust_date(self, val_date: date, convention: str, business_centers: Union[str, List[str]]) -> date:
        """
